...
abstract class Factory implements Macroable
{
    use Conditionable;
    use ForwardsCalls;
    use \MacropaySolutions\KernelDev\Framework\Traitables\MacropaySolutionsKernelDevDatabaseObviousFactoriesFactory {
        __call as macroCall;
    }
    ...
    final public function __construct(
        ...
        $this->for = $for ?? \di(Collection::class);
        $this->afterMaking = $afterMaking ?? \di(Collection::class);
        $this->afterCreating = $afterCreating ?? \di(Collection::class);
        $this->connection = $connection;
        $this->recycle = $recycle ?? \di(Collection::class);
     ...
     * @return ObviousCollection<int, Model|TModel>
     */
     ...
     * @param (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed> $attributes
     * @param Model|null $parent
     * @return ObviousCollection<int, Model|TModel>|Model|TModel
     */
     ...
     * @param Model|null $parent
     * @return \Closure(): (ObviousCollection<int, Model|TModel>|Model|TModel)
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Support\Collection $results
     * @return void
     */
...
//            return $this->for->isEmpty() ? $states : new Collection(array_merge([function () {
            return $this->for->isEmpty() ? $states : \di(Collection::class, [
                array_merge([
                    function () {
     ...
     *
     * @param \MacropaySolutions\KernelDev\Database\Obvious\Factories\Factory|\MacropaySolutions\Kernel\Support\Collection|Model|array $factory
     ...
     *
     * @param \MacropaySolutions\KernelDev\Database\Obvious\Factories\Factory|Model $factory
     * @param string|null $relationship
     * @return static
     */
     ...
     *
     * @param Model|\MacropaySolutions\Kernel\Support\Collection|array $model
     * @return static
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Support\Collection $instances
     * @return void
     */
     ...
     *
     * @param callable(class-string<Model>): class-string<\MacropaySolutions\KernelDev\Database\Obvious\Factories\Factory> $callback
     * @return void
     */
     ...
     *
     * @param class-string<Model> $modelName
     * @return class-string<\MacropaySolutions\KernelDev\Database\Obvious\Factories\Factory>
     */
    ...
    public function __call(string $method, array $parameters): mixed
    {
        ...
        $relatedModel = get_class($this->newModel()->callSegregatedRelation($relationship)->getRelated());
