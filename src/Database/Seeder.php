...
namespace MacropaySolutions\KernelDev\Database;

use InvalidArgumentException;
use MacropaySolutions\Kernel\Console\Command;
use MacropaySolutions\Kernel\Contracts\Container\Container;
use MacropaySolutions\Kernel\Support\Arr;
use MacropaySolutions\KernelDev\Database\Console\Seeds\WithoutModelEvents;
...
abstract class Seeder
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Console\Command
     */
    protected $command;
     ...
     *
     * @param string $class
     * @return \MacropaySolutions\Kernel\Database\Seeder
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Console\Command $command
     * @return $this
     */
