...
use MacropaySolutions\Kernel\Console\Prohibitable;
...
{
    use \MacropaySolutions\KernelDev\Framework\Traitables\MacropaySolutionsKernelDevDatabaseConsoleSeedsSeedCommand;
