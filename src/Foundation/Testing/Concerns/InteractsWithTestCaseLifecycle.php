...
use MacropaySolutions\KernelDev\Foundation\Testing\DatabaseTruncation;
use MacropaySolutions\KernelDev\Foundation\Testing\RefreshDatabase;
use MacropaySolutions\KernelDev\Foundation\Testing\WithFaker;
use MacropaySolutions\KernelDev\Foundation\Testing\WithoutEvents;
use MacropaySolutions\KernelDev\Foundation\Testing\WithoutMiddleware;
use MacropaySolutions\KernelDev\Support\Facades\ParallelTesting;
use Mockery;
...
trait InteractsWithTestCaseLifecycle
{
    ...
    protected function tearDownTheTestEnvironment(): void
    {
        ...
        if (\class_exists('\MacropaySolutions\KernelDev\Foundation\Console\AboutCommand')) {
            AboutCommand::flushState();
        }

        ConsoleApp::forgetBootstrappers();
